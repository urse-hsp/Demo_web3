...
import static com.nativernkeeptokenapp.repository.TokenRepository.getWeb3jService;
import static com.nativernkeeptokenapp.repository.TokensRealmSource.IMAGES_DB;
...
import com.nativernkeeptokenapp.entity.FragmentMessenger;
import com.nativernkeeptokenapp.entity.TokenLocator;
import com.nativernkeeptokenapp.entity.Wallet;
import com.nativernkeeptokenapp.entity.nftassets.NFTAsset;
import com.nativernkeeptokenapp.entity.tokens.ERC721Token;
import com.nativernkeeptokenapp.entity.tokens.Token;
import com.nativernkeeptokenapp.entity.tokens.TokenFactory;
import com.nativernkeeptokenapp.entity.tokenscript.EventUtils;
import com.nativernkeeptokenapp.entity.tokenscript.TokenScriptFile;
import com.nativernkeeptokenapp.entity.tokenscript.TokenscriptFunction;
...
import com.nativernkeeptokenapp.repository.entity.RealmCertificateData;
import com.nativernkeeptokenapp.repository.entity.RealmTokenScriptData;
    ...
    private String processLogs(EventDefinition ev, List<EthLog.LogResult> logs, String walletAddress)
    {
        ...
        for (int i = index; i >= 0; i--)
        {
            ...
            else
            {
                ...
                com.nativernkeeptokenapp.entity.Transaction tx = transactionRepository.fetchCachedTransaction(walletAddress, txHash);
...
//TODO                HomeActivity.setUpdatePrompt();
                break;
