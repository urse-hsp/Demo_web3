...
import com.nativernkeeptokenapp.entity.CustomViewSettings;
...
import static com.alphawallet.ethereum.EthereumNetworkBase.KTO_ID;
...
public abstract class EthereumNetworkBase implements EthereumNetworkRepositoryType {
    ...
    private static String DEFAULT_HOMEPAGE = "https://alphawallet.com/browser/";
    ...
    public static final String KTO_RPC_URL = "https://www.kortho-chain.com";
    ...
    private static final List<Long> hasValue = new ArrayList<>(Arrays.asList(
            MAINNET_ID, KTO_ID, CLASSIC_ID, XDAI_ID, POA_ID, ARTIS_SIGMA1_ID, BINANCE_MAIN_ID, HECO_ID, AVALANCHE_ID,
    ...
    private static final LongSparseArray<NetworkInfo> networkMap = new LongSparseArray<NetworkInfo>() {
        {
            ...
            put(KTO_ID, new NetworkInfo(C.KTO_NETWORK_NAME, C.KTO_SYMBOL,
                    KTO_RPC_URL,
                    "https://www.kortho.io/#/Td20/", KTO_ID,
                    KTO_RPC_URL, "https://www.kortho.io/api?"));
            put(CLASSIC_ID, new NetworkInfo(C.CLASSIC_NETWORK_NAME, C.ETC_SYMBOL,
                    CLASSIC_RPC_URL,
                    "https://blockscout.com/etc/mainnet/tx/", CLASSIC_ID,
                    CLASSIC_RPC_URL,"https://blockscout.com/etc/mainnet/api?"));
    ...
    private static final List<Long> hasGasOracleAPI = Arrays.asList(MAINNET_ID,KTO_ID, HECO_ID, BINANCE_MAIN_ID, MATIC_ID);
    ...
    public static void setDefaultDapp(String url) {
        DEFAULT_HOMEPAGE = url;
    }
