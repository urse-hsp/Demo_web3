...
import com.nativernkeeptokenapp.util.Hex;
...
import com.nativernkeeptokenapp.widget.ActionSheetMode;
...
public class Web3Transaction implements Parcelable {
     ...
     * @param minGas
     */
    public Web3Transaction(com.nativernkeeptokenapp.entity.Transaction tx, ActionSheetMode mode, BigInteger minGas)
    {
