...
import static com.nativernkeeptokenapp.C.BURN_ADDRESS;
import static com.nativernkeeptokenapp.C.ETHER_DECIMALS;
...
public class TransactionInput
{
    ...
    public String getOperationValue(Token token, Transaction tx)
    {
        ...
        switch (type)
        {
            ...
            case RECEIVED:
            case SEND:
                operationValue = token.getTransferValue(tx.transactionInput, 4);
                break;
            case BURN:
            case MINT:
                operationValue = token.getTransferValue(tx.transactionInput, 4);
            ...
            case DEPOSIT:
                //base value of tx
                operationValue = token.getTransactionValue(tx, 4);// .getTransferValue(tx.transactionInput, TRANSACTION_BALANCE_PRECISION);
                addSymbol = true;
                break;
            case UNKNOWN_FUNCTION:
            case INVALID_OPERATION:
