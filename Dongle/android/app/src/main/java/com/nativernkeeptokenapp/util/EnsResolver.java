package com.nativernkeeptokenapp.util;
...
import com.nativernkeeptokenapp.entity.UnableToResolveENS;
...
public class EnsResolver {
    ...
    private Function get(BigInteger nameId)
    {
        return new Function("get",
                            Arrays.asList(new Utf8String(EnsResolver.CRYPTO_ETH_KEY), new org.web3j.abi.datatypes.generated.Uint256(nameId)),
                            Arrays.asList(new TypeReference<Utf8String>()
                            {
                            }));
    }
